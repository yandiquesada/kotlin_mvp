...
import com.raywenderlich.android.creaturemon.preseneter.AllCreaturesContract
import com.raywenderlich.android.creaturemon.preseneter.AllCreaturesPresenter
...
class AllCreaturesActivity : AppCompatActivity(), AllCreaturesContract.View {
  ...
  override fun showCreaturesCleared() {
    Toast.makeText(this, R.string.creatures_cleared, Toast.LENGTH_LONG).show()
  }
}
